    ...
    $.extend($.summernote.lang, {
        'en-US': {
            ...
            image: {
                ...
                dragImageHere: 'Kéo ảnh ở vùng này',
                dropImage: 'Thả ảnh ở vùng này',
                selectFromFiles: 'Chọn từ file',
                maximumFileSize: 'Dung lượng file tối đa',
                maximumFileSizeError: 'Quá giới hạn dung lượng.',
                url: 'Đường dẫn ảnh',
                remove: 'Xóa ảnh'
            },
            video: {
                ...
                insert: 'Chèn video',
                url: 'Đường dẫn video?',
                providers: '(YouTube, Vimeo, Vine, Instagram, DailyMotion hoặc Youku)'
            },
            link: {
                link: 'Đường dẫn',
                ...
                unlink: 'Bỏ đường dẫn',
                edit: 'Sửa',
                textToDisplay: 'Tiêu đề hiển thi',
                url: 'Chọn đường dẫn?',
            ...
            context.memo('button.color', function () {
                return ui.buttonGroup({
                    ...
                    children: [
                        ...
                        ui.button({
                            className: 'dropdown-toggle font-color-dropdown',
                        ...
                        ui.dropdown({
                            items: [
                                '<li>',
                                '<div class="btn-group color-block-menu">',
